...
public class DurACuire extends Pouvoir {
    ...
    private static final String DESCRIPTION = "Vous pouvez poursuivre votre expansion "
            + "ET passer en déclin immédiatement après avoir pris vos jetons de "
            + "victoires, ce qui vous évite de perdre un tour pour passer en déclin. "
            + "Les règles du declin s'appliquent, vous ne marquez pas une seconde fois "
            + "les points de victoire en fin de tour.";
